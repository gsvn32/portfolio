    ...
    return (
        <div className="projects" role="region" aria-labelledby="projects-heading">
            ...
            <section className="project" tabIndex={0} aria-labelledby="travel-django-title">
                ...
                <a href="https://github.com/gsvn32/TravelDjango" target="_blank" aria-label="follow link to Travel Django code base">Click here</a>
            </section>
            ...
            <section className="project" tabIndex={0} aria-labelledby="gamemaster-title">
                ...
                <a href="https://github.com/gsvn32/GameMaster" target="_blank" aria-label="follow link to Game Master code base">Click here</a>
            </section>
            ...
            <section className="project" tabIndex={0} aria-labelledby="captionit-title">
                ...
                <a href="https://github.com/gsvn32/captionit" target="_blank" aria-label="follow link to caption it code base">Click here</a>
            </section>
            ...
            <section className="project" tabIndex={0} aria-labelledby="taskmaster-title">
                ...
                <a href="https://github.com/gsvn32/nodejs_todoapp" target="_blank" aria-label="follow link to nodejs todoapp code base">Click here</a>
            </section>
        </div>
    );
}
